...
if __name__ == '__main__':
    ...
    #train(100, 100, 'unet_train07.pt', model_log=None)
    #val('unet_train07.pt')
    #train(100, 200, 'unet_train07-2.pt', model_log=None)
    #train(20, 200, 'unet_train07-3.pt', model_log=None)
    #train(20, 200,'4af_unet_train07-1.pt', model_log=None)
    val('unet_train07-1.pt')
